...
elixir(function (mix) {
 mix.sass('app.scss', 'resources/assets/css/style.css')
     ...
     .scripts(['jquery.min.js', 'app.js', 'index.js', 'moment-with-locales.js', 'metismenu.js', 'jquery.imagemapster.js', 'validnif.js', './public/bower_components/angular-i18n/angular-locale_ca-es.js', './public/bower_components/pickadate/lib/picker.js', './public/bower_components/pickadate/lib/picker.date.js', './public/bower_components/pickadate/lib/picker.time.js', './public/bower_components/pickadate/lib/translations/ca_ES.js', 'modal.js'], 'public/js/desktop.js')
