...
@section('content')
            ...
            <row>
                <column cols="3">
                    ...
                    <section>
                        ...
                        {!! Form::text('birth_date', null, ['class'=> 'width-7', 'readonly' => 'readonly', 'ng-model' => 'patient.birth_date']) !!}
                    </section>
                </column>
                <column cols="6">
                    <section>
            ...
            <row>
                <column cols="4">
                    <section>
                        ...
                        {!! Form::text('date', null, ['ng-click' => 'today_date()', 'readonly' => 'readonly', 'class'=> 'width-10', 'ng-model' => 'review.date']) !!}
                    </section>
                </column>
                <column cols="6">
                    <section>
    ...
    <column cols="4" id="buscador-content" ng-controller="SearchController">
        ...
        {!! Form::hidden('url', URL::route('pacientsSearch'), ['ng-model' => 'search.url', 'name' => 'url', 'id' => 'url']) !!}
